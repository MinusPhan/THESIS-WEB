...
function isScreenWidthGreaterThan(maxWidth) {
  return window.matchMedia(`(min-width: ${maxWidth + 1}px)`).matches;
}

if (isScreenWidthGreaterThan(1024)) {
